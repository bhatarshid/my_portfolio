...
export const ContactComponent = function() {
  ...
  return <div id="contact" className="flex flex-col justify-center px-4 sm:px-6 lg-px-8 font-serif md:min-h-screen py-28">
      <div className="flex flex-col pb-2">
        ...
        <p className="text-center text-xl p-10 w-4/6 mx-auto">Feel free to Contact me by submitting the form below and I will get back to you as soon as possible</p>
        <form className="flex flex-col bg-white w-3/5 mx-auto rounded-md" onSubmit={handler} >
