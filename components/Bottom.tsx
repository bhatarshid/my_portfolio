...
export const BottomComponent = function() {
  return <div className="bg-black text-white sm:px-6 lg:px-8 font-sans pt-10">
    <div className="flex flex-col-reverse sm:flex-row justify-between mx-8 py-10">
      <div className="w-4/5 sm:w-3/5">
        <h2 className="font-bold text-xl pb-5 text-start">ARSHID BHAT</h2>
        <p className="text-justify">A Frontend focused Web Developer building the Frontend of Websites and Web Applications that leads to the success of the overall product.  </p>
      </div>
      <div className="mb-8 sm:mb-0">
        <h2 className="font-bold text-xl pb-5 flex justify-start">SOCIAL</h2>
