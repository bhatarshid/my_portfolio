...
export const ProjectComponent = function() {
  return <>
    <div id="project" className="flex flex-col justify-center px-4 sm:px-6 lg:px-8 md:min-h-screen py-28">
      <div className="flex flex-col pb-2">
        <h2 className="text-2xl sm:text-4xl font-bold text-center">PROJECTS</h2>
        <hr className="border-t-4 border-customPurple rounded-full w-10 mx-auto mt-5"/>
        <p className="text-center text-base sm:text-xl font-medium mx-auto md:w-1/2 px-10 py-8 md:px-0">Here you will find some of the projects that I worked on.</p>
      </div>
